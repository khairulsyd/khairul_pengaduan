...
class C_khairul_auth extends CI_Controller
{
	...
	public function index()
	{
		...
		if ($this->form_validation->run() == false) {
			...
			$this->load->view('auth/v_khairul_login');
		} else {
	...
	public function registrasi()
	{
		...
		if ($this->form_validation->run() == false) {
			...
			$this->load->view('auth/v_khairul_registrasi');
		} else {
			$data = [
	...
	public function login_petugas()
	{
		...
		if ($this->form_validation->run() == false) {
			...
			$this->load->view('admin_auth/v_khairul_loginadmin');
		} else {
	...
	public function _loginadmin()
	{
		...
		if ($petugas) {
			...
			Password Salah !
				...
				redirect('C_khairul_auth/login_petugas');
			}
		} else {
			$this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">
			Username tidak terdaftar !
	...
	public function registrasi_admin()
	{
		...
		$this->M_khairul_Admin->insertPetugas($tambahPetugas);
		$this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Selamat anda sudah daftar, Silahkan login!</div>');
	...
	public function setup_admin()
	{
		...
		if ($this->form_validation->run() == false) {
			$this->load->view('admin_auth/v_khairul_setupadmin');
		} else {
			...
			$this->M_khairul_Admin->insertAdmin($tambahAdmin);
